// Local dev entry point (run via `npm run dev`). All app setup lives in
// ./app.js — this file only starts the server. Keep server.js and index.js
// (Vercel) as thin wrappers so the two never drift apart again.
